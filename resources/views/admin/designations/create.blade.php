...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.designations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="section_id">{{ trans('cruds.designation.fields.section') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.designation.fields.section_helper') }}</span>
            </div>
            <div class="form-group">
