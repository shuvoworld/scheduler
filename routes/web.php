...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Officer
    Route::delete('officers/destroy', 'OfficerController@massDestroy')->name('officers.massDestroy');
    ...
    Route::post('schedules/ckmedia', 'ScheduleController@storeCKEditorImages')->name('schedules.storeCKEditorImages');
